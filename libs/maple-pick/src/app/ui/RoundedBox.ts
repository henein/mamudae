...
export class RoundedBox extends Container {
  ...
  constructor(options: Partial<RoundedBoxOptions> = {}) {
    ...
    this.image = new NineSlicePlane(Texture.from("rounded-rectangle.png"), 34, 34, 34, 34);
    ...
    if (opts.shadow) {
      this.shadow = new NineSlicePlane(Texture.from("rounded-rectangle.png"), 34, 34, 34, 34);
